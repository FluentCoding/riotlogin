...
pub fn get_taskbar_size() -> Option<RECT> {
  unsafe {
      ...
      if SystemParametersInfoW(SPI_GETWORKAREA, 0, Some(&mut work_area as *mut RECT as *mut _), SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS(0)).is_err() {
